...
/*
 * This file contains the function WebRtcSpl_ComplexBitReverse_mips().
...
static WebRtc_Word16 coefTable_7[] = {
...
static WebRtc_Word16 coefTable_8[] = {
...
void WebRtcSpl_ComplexBitReverse(WebRtc_Word16 frfi[], int stages)
{
    ...
    WebRtc_Word32 *ptr_i, *ptr_j;

    if (stages == 8)
    {
        WebRtc_Word16 *pcoeftable_8 = coefTable_8;
        ...
        __asm__ volatile(
           ...
           "1:                                                             \n\t"
            ...
            : [tmp1] "=&r" (tmp1), [tmp2] "=&r" (tmp2), [ptr_i] "=&r" (ptr_i),
              [ptr_j] "=&r" (ptr_j), [tr] "=&r" (tr), [l] "=&r" (l), [tmp3] "=&r" (tmp3),
              [pcoeftable_8] "+r" (pcoeftable_8), [ti] "=&r" (ti), [tmp4] "=&r" (tmp4)
            : [frfi] "r" (frfi)
            : "memory"
        );
   ...
   {
        WebRtc_Word16 *pcoeftable_7 = coefTable_7;
